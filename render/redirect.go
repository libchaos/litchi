...
// RedirectResponse is a http.Response that performs redirects.
...
func (r RedirectResponse) Write(w http.ResponseWriter) {
	http.Redirect(w, r.Request, r.LocationURL, r.StatusCode)
}
...
func Redirect(r *http.Request, locationURL string, permanent, preserveMethod bool) RedirectResponse {
	if !permanent {
		if !preserveMethod {
...
//
// [301 Moved Permanently]: https://developer.mozilla.org/en-US/docs/Web/HTTP/Status/301
func MovedPermanently(r *http.Request, locationURL string) RedirectResponse {
...
//
// [302 Found]: https://developer.mozilla.org/en-US/docs/Web/HTTP/Status/302
func Found(r *http.Request, locationURL string) RedirectResponse {
...
//
// [307 Temporary Redirect]: https://developer.mozilla.org/en-US/docs/Web/HTTP/Status/307
func TemporaryRedirect(r *http.Request, locationURL string) RedirectResponse {
...
//
// [308 Permanent Redirect]: https://developer.mozilla.org/en-US/docs/Web/HTTP/Status/308
func PermanentRedirect(r *http.Request, locationURL string) RedirectResponse {
...
func SeeOther(r *http.Request, locationURL string) RedirectResponse {
