...
func TestBody(t *testing.T) {
	...
	tests := []struct {
		description    string
		body           string
		function       func(r *http.Request) (any, error)
		contentType    string
		expectedResult any
...
--BOUNDARY--`,
	...
	for _, test := range tests {
		...
		t.Run(test.description, func(t *testing.T) {
			...
			require.True(t,
				cmp.Equal(test.expectedResult, result, cmpopts.IgnoreUnexported(multipart.FileHeader{}, http.Request{})),
				cmp.Diff(test.expectedResult, result, cmpopts.IgnoreUnexported(multipart.FileHeader{}, http.Request{})),
			)
		})
	}
}
