...
// # Validations
//
// The bind package is integrated with the [github.com/libchaos/litchi/validate] package. If a struct passed as type
// parameter for [Request], [URIParameters], [Body], [Query] or [Header] implements the
// [github.com/libchaos/litchi/validate.Validatable] interface with a pointer receiver, these binding functions validate
